...
M.explorer = {
  ...
  win = {
    list = {
      keys = {
        ["<BS>"] = { "explorer_up", desc = "Explorer: Go to parent directory" },
        ["l"] = { "confirm", desc = "Explorer: Confirm selection" },
        ["h"] = { "explorer_close", desc = "Explorer: Close directory" },
        ["a"] = { "explorer_add", desc = "Explorer: Add item" },
        ["d"] = { "explorer_del", desc = "Explorer: Delete item" },
        ["r"] = { "explorer_rename", desc = "Explorer: Rename item" },
        ["c"] = { "explorer_copy", desc = "Explorer: Copy item" },
        ["m"] = { "explorer_move", desc = "Explorer: Move item" },
        ["o"] = { "explorer_open", desc = "Explorer: Open with system application" },
        ["P"] = { "toggle_preview", desc = "Explorer: Toggle preview" },
        ["y"] = { "explorer_yank", mode = { "n", "x" }, desc = "Explorer: Yank item" },
        ["p"] = { "explorer_paste", desc = "Explorer: Paste item" },
        ...
        ["Z"] = { "explorer_close_all", desc = "Explorer: Close all directories" },
        ["]g"] = { "explorer_git_next", desc = "Explorer: Next git change" },
        ["[g"] = { "explorer_git_prev", desc = "Explorer: Previous git change" },
        ["]d"] = { "explorer_diagnostic_next", desc = "Explorer: Next diagnostic" },
        ["[d"] = { "explorer_diagnostic_prev", desc = "Explorer: Previous diagnostic" },
        ["]w"] = { "explorer_warn_next", desc = "Explorer: Next warning" },
        ["[w"] = { "explorer_warn_prev", desc = "Explorer: Previous warning" },
        ["]e"] = { "explorer_error_next", desc = "Explorer: Next error" },
        ["[e"] = { "explorer_error_prev", desc = "Explorer: Previous error" },
      },
    },
  },
}
